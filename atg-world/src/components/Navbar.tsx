const Navbar = () => {
    return ( 
        <div className="w-screen md:flex flex-row justify-between py-1 px-6 h-[72px] hidden text-black">
            ...
            <div className="flex my-auto gap-1 sm:gap-0 w-auto text-black text-[12px] lg:text-[16px]">
